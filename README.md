Hi 👋, I'm Yashraj Rathore
==========================

A Full-Stack Developer & Backend Engineer (FastAPI + Next.js + Firebase)

• All of my projects are available on my GitHub:  
  **https://github.com/Yashraj-Rathore**

• Currently located in Toronto, Canada 🇨🇦

• How to reach me: **rathore.yash6@yahoo.com**
...
• **Vosyn Connect** — a multilingual developer platform  
  (FastAPI + Firebase + Supabase + Next.js + Cloud Run)

• **Analytics Dashboards** — campaigns, API usage, localization & billing

• **API Explorer & Docs Renderer** — dynamic code samples + live requests

• **Video/Audio Localization Pipeline** — generating signed URLs, translations, and previews

• **Budget Analysis Dashboard** — Angular + Django full-stack personal finance app
